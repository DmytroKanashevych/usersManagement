<cfinclude template = "./queries/users.cfm">

<cfset request.pageTitle = "DB users">
    ...
    <div class="row justify-content-center">
      <div class="col-md-6 col-lg-4">
        <div class="text-center my-3">
          ...
          <form action="./actions/insert.cfm" method="post">
            <div class="mb-3">
...
<cfoutput query = "users">
      <tr>
        ...
        <td>#email#</td>
        <td>
        <a href="edit.cfm?id=#id#" class="btn btn-sm btn-outline-success mr-2">
        ...
        <a href="./actions/delete.cfm?id=#id#" class="btn btn-sm btn-outline-danger">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi 
